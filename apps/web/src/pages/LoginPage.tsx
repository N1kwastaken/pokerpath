  ...
  return (
    <div className="flex min-h-dvh flex-col justify-center px-6 py-10">
      ...
      <div className="flex flex-col items-center text-center">
        <div className="flex h-16 w-16 items-center justify-center rounded-3xl bg-gradient-to-br from-primary to-primary-press text-4xl font-black text-white shadow-pop">♠</div>
